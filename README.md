...
... where $std(s,v,a)$ is the set of all standard deviations $std(s,v,a)_i$ from observations of a particular measure for an identifying combination of a study, volunteer, and activity.
